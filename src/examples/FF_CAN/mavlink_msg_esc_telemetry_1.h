                               ...
                               const int16_t *RPM, const uint16_t *Voltage, const int16_t *Current, const uint8_t *Temperature, const uint8_t *errorCount, const uint8_t *errorState)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ESC_TELEMETRY_1_MIN_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_CRC);
}
                                   ...
                                   const int16_t *RPM,const uint16_t *Voltage,const int16_t *Current,const uint8_t *Temperature,const uint8_t *errorCount,const uint8_t *errorState)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ESC_TELEMETRY_1;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ESC_TELEMETRY_1_MIN_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_esc_telemetry_1_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_esc_telemetry_1_t* esc_telemetry_1)
{
    return mavlink_msg_esc_telemetry_1_pack(system_id, component_id, msg, esc_telemetry_1->RPM, esc_telemetry_1->Voltage, esc_telemetry_1->Current, esc_telemetry_1->Temperature, esc_telemetry_1->errorCount, esc_telemetry_1->errorState);
}
 ...
 * @param esc_telemetry_1 C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_esc_telemetry_1_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_esc_telemetry_1_t* esc_telemetry_1)
{
    return mavlink_msg_esc_telemetry_1_pack_chan(system_id, component_id, chan, msg, esc_telemetry_1->RPM, esc_telemetry_1->Voltage, esc_telemetry_1->Current, esc_telemetry_1->Temperature, esc_telemetry_1->errorCount, esc_telemetry_1->errorState);
}
...
static inline void mavlink_msg_esc_telemetry_1_send(mavlink_channel_t chan, const int16_t *RPM, const uint16_t *Voltage, const int16_t *Current, const uint8_t *Temperature, const uint8_t *errorCount, const uint8_t *errorState)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN];
    ...
    _mav_put_uint8_t_array(buf, 56, errorCount, 8);
    _mav_put_uint8_t_array(buf, 64, errorState, 8);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ESC_TELEMETRY_1, buf, MAVLINK_MSG_ID_ESC_TELEMETRY_1_MIN_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_CRC);
#else
    mavlink_esc_telemetry_1_t packet;
    ...
    mav_array_memcpy(packet.errorCount, errorCount, sizeof(uint8_t)*8);
    mav_array_memcpy(packet.errorState, errorState, sizeof(uint8_t)*8);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ESC_TELEMETRY_1, (const char *)&packet, MAVLINK_MSG_ID_ESC_TELEMETRY_1_MIN_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_esc_telemetry_1_send_struct(mavlink_channel_t chan, const mavlink_esc_telemetry_1_t* esc_telemetry_1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_esc_telemetry_1_send(chan, esc_telemetry_1->RPM, esc_telemetry_1->Voltage, esc_telemetry_1->Current, esc_telemetry_1->Temperature, esc_telemetry_1->errorCount, esc_telemetry_1->errorState);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ESC_TELEMETRY_1, (const char *)esc_telemetry_1, MAVLINK_MSG_ID_ESC_TELEMETRY_1_MIN_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_LEN, MAVLINK_MSG_ID_ESC_TELEMETRY_1_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_esc_telemetry_1_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const int16_t *RPM, const uint16_t *Voltage, const int16_t *Current, const uint8_t *Temperature, const uint8_t *errorCount, const uint8_t *errorState)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline void mavlink_msg_esc_telemetry_1_decode(const mavlink_message_t* msg, mavlink_esc_telemetry_1_t* esc_telemetry_1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
